...
void IMUSO3Thread(void)
{
	...
	float acc_temp[3] = {0.0f, 0.0f, 0.0f};		//m/s^2
	float gyro_temp[3] = {0.0f, 0.0f, 0.0f};		//rad/s
...
//	mag_temp[2] = (float)imu.magRaw[2];
		...
		NonlinearSO3AHRSupdate(gyro_temp[0], gyro_temp[1], gyro_temp[2],
							-acc_temp[0], -acc_temp[1], -acc_temp[2],
